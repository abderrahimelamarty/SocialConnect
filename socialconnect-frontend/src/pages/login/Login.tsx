...
const Login = () => {
  ...
  return (
    ...
    <div className="md:w-1/3 max-w-sm">
      ...
      <input className="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded" type="text"  name="username" placeholder="username"  onChange={onChangeUsername}/>
